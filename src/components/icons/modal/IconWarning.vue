<template lang="">
	...
	C-0.007,114.61,114.606,0,256.004,0C397.394,0,512,114.614,512,256.006z"
            ...
            <path
                style="fill: #36bb9a"
                d="M511.712,267.373c-0.119-0.137-0.238-0.274-0.368-0.402
	...
	C399.729,505.913,505.926,399.705,511.712,267.373z"
            ...
            <g>
                <polygon
                    style="fill: #f4f6f9"
                    points="427.788,253.013 427.788,253.017 427.788,253.017 	"
                />
                <path
                    style="fill: #f4f6f9"
                    d="M255.876,84.217c-46.032,0.791-89.349,19.387-121.969,52.361
		...
		c29.253,28.943,45.765,68.07,46.495,110.17C412.847,253.276,412.847,253.276,412.847,253.276z"
                ...
                <path
                    style="fill: #f4f6f9"
                    d="M256,285.885c4.126,0,7.47-3.345,7.47-7.47V158.892c0-4.126-3.345-7.47-7.47-7.47
		c-4.126,0-7.47,3.345-7.47,7.47v119.522C248.53,282.54,251.874,285.885,256,285.885z"
                />
                <path
                    style="fill: #f4f6f9"
                    d="M256.007,315.765h-0.27c-8.241,0-14.821,6.954-14.675,15.195c0.139,8.17,6.798,14.686,14.93,14.686
